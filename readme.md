[![GitHub](https://img.shields.io/github/tag/DeadlyGuy505/binance-trade-bot.svg?label=GitHub%20Release)](https://github.com/DeadlyGuy505/binance-trade-bot/releases)
[![PyPi](https://badge.fury.io/py/binance-trade-bot.svg)](https://pypi.org/project/binance-trade-bot/#history)
![Docker](https://img.shields.io/docker/v/mbeinig/binance-trade-bot?sort=semver&label=Docker%20Release)

[![Docker Pulls](https://img.shields.io/docker/pulls/mbeinig/binance-trade-bot.svg?style=flat-square)](https://hub.docker.com/r/mbeining/binance-trade-bot/)
![GitHub repo size](https://img.shields.io/github/repo-size/DeadlyGuy505/binance-trade-bot.svg)
[![License](https://img.shields.io/badge/License-GPLv3-blue.svg)](LICENSE)
![GitHub last commit](https://img.shields.io/github/last-commit/DeadlyGuy505/binance-trade-bot.svg)
![GitHub top language](https://img.shields.io/github/languages/top/DeadlyGuy505/binance-trade-bot.svg)
[![GitHub issues](https://img.shields.io/github/issues/DeadlyGuy505/binance-trade-bot.svg)](https://github.com/DeadlyGuy505/binance-trade-bot/issues)

# Binance Trade Bot
<img src="https://raw.githubusercontent.com/DeadlyGuy505/binance-trade-bot/master/botLogo.png" width="250">
